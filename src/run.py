...
if __name__ == "__main__":
    ...
    parser.add_argument("--task_level", default=0, help="curriculum level of the environment")
    ...
    server = create_server(env_config=env_config, model_checkpoint=cp, curr_level=args.task_level)
