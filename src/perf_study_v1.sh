...
python /itet-stor/kpius/net_scratch/si_bees/src/train.py --location "cluster" --performance_study --ray_threads $ray_threads --rollout_workers $rollout_workers --cpus_per_worker $cpus_per_worker --cpus_for_local_worker $cpus_for_local_worker
